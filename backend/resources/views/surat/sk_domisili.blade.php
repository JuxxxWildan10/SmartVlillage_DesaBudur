...
<div style="text-align: center; margin-bottom: 20px;">
    ...
    <p style="margin: 0;">Nomor: {{ $surat->nomor_surat ?? '470 / ' . $surat->id . ' / DESA' }}</p>
</div>
...
<p>Orang tersebut di atas adalah benar-benar warga yang berdomisili dan bertempat tinggal di Desa Budur, Kecamatan Ciwaringin, Kabupaten Cirebon.</p>
